...
void Shader::SetUniform4fv(const char * paramNameString, glm::mat4 mat) {
	glUniformMatrix4fv(glGetUniformLocation(ID, paramNameString), 1, GL_FALSE, glm::value_ptr(mat));
}
