...
//		return -1;
//	}
//	glViewport(0, 0, SCR_WIDTH, SCR_HEIGHT);		//控制可绘制区域
...
//		glUniform3f(glGetUniformLocation(myShader->ID, "ambientColor"), 0.5f, 0.5f, 0.5f);	//环境光
//
...
//			//通过uniform传入变换矩阵，传入坐标变换的uniform
...
////		myMaterial->shader->SetUniform1i("material.specular", Shader::SPECULAR);
////		myMaterial->shader->SetUniform1f("material.shininess", myMaterial->shininess);
//////		glUniform1i(glGetUniformLocation(myShader->ID, "material.diffuse"), 2);
//		glBindVertexArray(planeVAO);
